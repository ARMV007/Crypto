...
struct ChartView: View {
    ...
    init(coin: CoinModel) {
        ...
        lineColor = priceChange > 0 ? .cryptoGreen : .cryptoRed
...
extension ChartView {
    private var chartView: some View {
        GeometryReader { geometry in
            ...
            .shadow(color: lineColor.opacity(0.5), radius: 15, x: 0.0, y: 30)
            .shadow(color: lineColor.opacity(0.2), radius: 20, x: 0.0, y: 50)
            .shadow(color: lineColor.opacity(0.1), radius: 25, x: 0.0, y: 70)
        }
    }
